#showcasing the Uniform Cost Tree search
...
log_file = open("reports_uniformcosttree.log","w")
sys.stdout = log_file
...
startTime = time.time()
path = UniformCostSearch(mygraph, [2, 2], True, firsFive, created, expanded)
...
if time.time() - startTime >= 3600:
    print("The solution was not found within an hour")
else:
...
startTime = time.time()
path = UniformCostSearch(mygraph, [3, 2], True, firsFive, created, expanded)
